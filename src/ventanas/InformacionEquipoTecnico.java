...
public class InformacionEquipoTecnico extends javax.swing.JFrame {
    ...
    public InformacionEquipoTecnico() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                jLabel_revisionTecnicaDe.setText("Comentarios y actualización del técnico: " + rs.getString("revicion_tecnica"));
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        cmb_tipoequipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laptop", "Destop", "Impresora", "Multifuncional" }));
        ...
        cmb_estatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nuevo Ingreso", "No reparado", "En revision", "Reparto", "Entregado" }));
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        try {
            Connection cn = Conexion.conectar();
            PreparedStatement pst = cn.prepareStatement(
                "update equipos set status=?, comentarios_tecnicos=?, revicion_tecnica=? "
