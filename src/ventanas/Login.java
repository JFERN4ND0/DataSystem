...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        ImageIcon w_logo = new ImageIcon("src/images/DS.png");
        Icon i_logo = new ImageIcon(w_logo.getImage().getScaledInstance(jLabel_Logo.getWidth(),
                jLabel_Logo.getHeight(), Image.SCALE_DEFAULT));
        jLabel_Logo.setIcon(i_logo);
        this.repaint();
    }
    ...
    private void initComponents() {
        ...
        jLabel_Footer.setText("creado por la Geekipedia de Ernestto ®");
        getContentPane().add(jLabel_Footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(91, 480, -1, -1));
